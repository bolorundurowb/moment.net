...
[TestFixture]
public class RelativeTimeThresholdTests : IDisposable
{
    private readonly CultureWrapper _cultureWrapper;

    public RelativeTimeThresholdTests() => _cultureWrapper = new CultureWrapper(CultureInfo.InvariantCulture);
    ...
    public void FromNow_SecondsThresholds(int seconds, string expected)
    {
        ...
        past.From(now, true).ShouldBe(expected);
    }
    ...
    public void FromNow_LocalTime_ReturnsCorrectRelativeTime()
    {
        ...
        past.FromNow(true).ShouldBe("5 minutes");
    }
    ...
    public void ToNow_LocalTime_ReturnsCorrectRelativeTime()
    {
        ...
        future.ToNow(true).ShouldBe("5 minutes");
    }
