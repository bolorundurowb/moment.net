...
public class StartOfDateTimeOffsetTests : IDisposable
{
    ...
    public void StartOf_Minute_TruncatesSecondsToZero()
    {
        ...
        (result.ToString("dd/MM/yyyy HH:mm:ss") == "01/05/2008 08:30:00").VerifyExpression();
    }
    ...
    public void StartOf_Hour_TruncatesMinutesAndSecondsToZero()
    {
        ...
        (result.ToString("dd/MM/yyyy HH:mm:ss") == "01/05/2008 08:00:00").VerifyExpression();
    }
    ...
    public void StartOf_Day_TruncatesTimeToMidnight()
    {
        ...
        (result.ToString("dd/MM/yyyy HH:mm:ss") == "01/05/2008 00:00:00").VerifyExpression();
    }
    ...
    public void StartOf_Week_ReturnsPrecedingSunday()
    {
        ...
        (result.ToString("dd/MM/yyyy HH:mm:ss") == "27/04/2008 00:00:00").VerifyExpression();
    }
    ...
    public void StartOf_IsoWeek_ReturnsPrecedingMonday()
    {
        ...
        (result.ToString("dd/MM/yyyy HH:mm:ss") == "28/04/2008 00:00:00").VerifyExpression();
    }
    ...
    public void StartOf_Quarter_ReturnsFirstDayOfQuarter()
    {
        ...
        (result.ToString("dd/MM/yyyy HH:mm:ss") == "01/04/2008 00:00:00").VerifyExpression();
    }
    ...
    public void StartOf_Year_ReturnsJanuaryFirstAtMidnight()
    {
        ...
        (result.ToString("dd/MM/yyyy HH:mm:ss") == "01/01/2008 00:00:00").VerifyExpression();
    }

    [Test]
    public void StartOf_InvalidAnchor_ThrowsArgumentException()
    {
        OmniAssert.Assert.Throws<ArgumentException>(() => { May2008PlusTwoHours.StartOf((DateTimeAnchor)99); });
    }
